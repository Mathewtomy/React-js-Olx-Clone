...
import "./allposts.css";
import {data,Fresh} from '../Posts/Data';
function AllPosts() {
  ...
  let length = posts.length; //if user refresh the whole page context will be empty so we want to redirect the user to the home page
  ...
  let showTheseItems=posts.slice(indexOfFirstDish,indexOfLastDish)
